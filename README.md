...
What the application does:
	The application allows a user to insert their city, state, and zip code in order for the browser to display indoor and outdoor activities in the input location.  
